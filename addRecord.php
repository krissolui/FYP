...
if(checkParameter($_POST['ip_address']) && checkPara($_POST['current']) && checkPara($_POST['voltage'])) {
    $testHttp = fopen("testHttp.txt", "w");
    $txt = "ip_address=" . $_POST['ip_address'] . "\tcurrent=" . $_POST['current'] . "\tvoltage=" . $_POST['voltage'] . "\n";
    fwrite($testHttp, $txt);
    fclose($testHttp);
}
?>
